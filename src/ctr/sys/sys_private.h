...
extern int sys_wait_synchronization2(int32_t* out, uint32_t* handles, int32_t handles_num, uint8_t wait_all, int64_t nanoseconds);
...
extern int sys_map_memoryblock(uint32_t handle, uint32_t address, uint32_t perm, uint32_t perm_alt);
